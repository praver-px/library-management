  ...
  <div style="width: 80%">
    ...
    <el-form :inline="true" :rules="rules" ref="ruleForm" :model="form" label-width="100px">
      ...
      <el-form-item label="借书积分" prop="cover">
        <el-input-number v-model="form.score" :min="5" :max="30" label="所需积分"></el-input-number>
      </el-form-item>
      <el-form-item label="数量" prop="nums">
        <el-input-number v-model="form.nums" :min="0" :max="300" label="数量"></el-input-number>
      </el-form-item>
      <br>
      <el-form-item label="封面" prop="avatar">
        <el-upload
            class="avatar-uploader"
            :action="'http://localhost:8090/api/file/upload?&token=' + this.admin.token"
